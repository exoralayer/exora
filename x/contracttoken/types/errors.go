...
var (
	...
	ErrTokenExists                = errors.Register(ModuleName, 2, "attempting to create a token that already exists (has bank metadata)")
	...
	ErrTokenDoesNotExist          = errors.Register(ModuleName, 10, "token does not exist")
