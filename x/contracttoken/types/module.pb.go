...
// source: gluon/contracttoken/module/v1/module.proto
...
func init() {
	proto.RegisterType((*Module)(nil), "gluon.contracttoken.module.v1.Module")
}

func init() {
	proto.RegisterFile("gluon/contracttoken/module/v1/module.proto", fileDescriptor_41ef53b3485257b5)
}
