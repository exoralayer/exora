...
// source: exora/contracttoken/v1/metadata.proto
...
func init() {
	proto.RegisterType((*DenomAuthorityMetadata)(nil), "exora.contracttoken.v1.DenomAuthorityMetadata")
	proto.RegisterType((*WhitelistedHook)(nil), "exora.contracttoken.v1.WhitelistedHook")
}

func init() {
	proto.RegisterFile("exora/contracttoken/v1/metadata.proto", fileDescriptor_b7d58767d0ca1f25)
}
