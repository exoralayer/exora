...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"exora", "contracttoken", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Token_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"exora", "contracttoken", "v1", "tokens", "contract_address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Tokens_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"exora", "contracttoken", "v1", "tokens"}, "", runtime.AssumeColonVerbOpt(false)))
)
